set terminal postscript eps size 13cm,10cm enhanced color font 'Helvetica,30' #--> put large font size!
set output 'energy_1010.eps'
...
set xlabel 'k_{||} ({/Symbol p}/T)' offset 0.0,0.2
set mxtics 5
...
N = system("awk 'NR==1{print NF}' tube.Enk.xyy.101012")
plot for [col=19:27] "tube.Enk.xyy.101012" u 1:col w l ls 11
