...
unset title
set ylabel '{/Symbol e}_1 (Lorentzian)' offset 1.5,0.0
set mytics 5
set xlabel 'Energy (eV)' offset 0.0,0.2
set mxtics 5
unset key
plot 'tube.eps1.xyy.230' using 1:2 w l ls 11
#
set xlabel 'Energy (eV)' offset 0.0,0.2
set mxtics 5
...
set mytics 5
unset key
plot 'tube.eps2.xyy.230' using 1:2 w l ls 11
